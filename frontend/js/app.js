...
function renderStudents(students) {
    ...
    students.forEach(student => {
        const annualAllowance = Number(student.allowance) * 12;
        ...
        row.innerHTML = `
            ...
            <td>${annualAllowance.toLocaleString()}</td>
            <td>
...
async function handleSubmit(e) {
    ...
    const studentData = {
        ...
        allowance: allowanceInput.value.trim() // MONTHLY allowance
    };
...
async function editStudent(id) {
    try {
        ...
        allowanceInput.value = student.allowance; // MONTHLY value
